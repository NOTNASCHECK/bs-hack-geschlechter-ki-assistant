...
const Privat = () => {
  ...
  const apiUrl = process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}/api/ai/guidelines` : 'http://localhost:3000/api/ai/guidelines';
  ...
  return (
    <div className="flex flex-col bg-background text-foreground items-center justify-center custom-div">
      <h2 className="text-4xl font-bold mb-4">Europäische Guidelines</h2>
