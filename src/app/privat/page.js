      ...
      const response = await fetch("https://bs-hack-geschlechter-ki-assistant.vercel.app/api/schnipsel", {
        ...
        body: JSON.stringify({
          messages: [
            {
              role: 'user',
              content: requestText + 'Antwortformat: 1. ZUSAMMENFASSUNG: - Prägnante Zusammenfassung der Hauptergebnisse (3-5 Sätze) 2. FEEDBACK: - Wichtigste Erkenntnisse in Stichpunkten - Identifizierte Stärken und Schwächen - Konkrete Verbesserungsvorschläge 3. ABWEICHUNGEN: - Liste aller relevanten Abweichungen vom erwarteten Ergebnis - Kategorisierung nach Schweregrad (kritisch, bedeutend, geringfügig) - Potenzielle Auswirkungen der Abweichungen 4. EMPFEHLUNGEN: - Priorisierte Handlungsempfehlungen, basierend auf den Erkenntnissen 5. QUELLENVERWEISE: - [Q1] Verweis auf Quellendatei 1, Seite/Abschnitt X: "Zitat oder relevante Passage" - [Q2] Verweis auf Quellendatei 2, Seite/Abschnitt Y: "Zitat oder relevante Passage" - Weitere Quellen mit präzisen Seitenangaben und Zitaten.',
            },
          ],
        }),
      });
